                        ...
                        <div class="widget-content nopadding">
                            <form name="form1" action="" method="post" class="form-horizontal">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                       <input type="text" required name="product_name" class="span11" placeholder="Enter Product Name">
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" required name="packing_size" class="span11" placeholder="Enter Packing Size">
                                    </div>
                                </div>
