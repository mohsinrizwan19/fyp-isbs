...
{
 mysqli_query($link,"update user_registration set firstname='$_POST[firstname]',lastname='$_POST[lastname]',password=md5('$_POST[password]'),role='$_POST[role]',status='$_POST[role]' where id=$id") or die(mysqli_error($link));
?>
    <script type="text/javascript">
